...
class MonsterGenerator(tk.Tk):
    ...
    def __init__(self):
        ...
        self.topLabel = tk.Label(self, text=infoText, wraplength=300, justify="center", background=TAN, font=(FONT, 10, "bold"))
        self.topLabel.grid(column=0, row=0, padx=5, pady=5)
        
        # Create the terrain container
        self.terrainContainer = tk.Frame(self, borderwidth=2, relief="groove", bg=LIGHT)
        self.terrainContainer.grid(column=0, row=1, sticky=tk.W, padx=5, pady=5)
        terrainDescriptor = "Terrain Description: "
        self.terrainLabel = tk.Label(self.terrainContainer, text = terrainDescriptor, background=LIGHT, font=(FONT, 8, "bold"))
        self.terrainLabel.grid(column=0, row=0, sticky=tk.W, padx=5, pady=5)
        
        self.terrainInput = tk.Text(self.terrainContainer, height = 1, width = 20, font=(FONT, 8))
        self.terrainInput.grid(column=1, row=0, sticky=tk.W, padx=5, pady=5)
